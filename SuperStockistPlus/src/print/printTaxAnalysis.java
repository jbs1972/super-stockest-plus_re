...
public class printTaxAnalysis {
    ...
    public printTaxAnalysis(SaleMaster sm, Enterprise e, Distributer d) {
        this.sm = sm;
        this.e = e;
        this.d = d;
...
//        }
    ...
    private class IntroPage implements Printable {
        ...
        public int print(Graphics g, PageFormat pageFormat, int page) {
            ...
            titleText = d.getDdist()+" - "+d.getDpin();
            titleX = rightbound - fontMetrics.stringWidth(titleText);
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            ...
            fontMetrics = g2d.getFontMetrics();
            titleText = "GSTIN: ";
            titleX = rightbound - fontMetrics.stringWidth("GSTIN: "+d.getDgstno());
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            titleFont = new Font("Arial", Font.PLAIN, 8);
            g2d.setFont(titleFont);
            fontMetrics = g2d.getFontMetrics();
            titleText = d.getDgstno();
            titleX = rightbound - fontMetrics.stringWidth(d.getDgstno());
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            ...
            fontMetrics = g2d.getFontMetrics();
            titleText = "GST State: ";
            titleX = rightbound - fontMetrics.stringWidth("GST State: "+d.getDstate()+".    State Code: "+d.getDstatecode());
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            titleFont = new Font("Arial", Font.PLAIN, 8);
            g2d.setFont(titleFont);
            fontMetrics = g2d.getFontMetrics();
            titleText = e.getEstate();
            titleX = rightbound - fontMetrics.stringWidth(d.getDstate()+".    State Code: "+d.getDstatecode());
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            titleFont = new Font("Arial", Font.BOLD, 8);
            g2d.setFont(titleFont);
            fontMetrics = g2d.getFontMetrics();
            titleText = ".    State Code: ";
            titleX = rightbound - fontMetrics.stringWidth(".    State Code: "+d.getDstatecode());;
            g2d.drawString(titleText, (int) titleX, (int) titleY);
            titleFont = new Font("Arial", Font.PLAIN, 8);
            g2d.setFont(titleFont);
            fontMetrics = g2d.getFontMetrics();
            titleText = e.getEstatecode();
            titleX = rightbound - fontMetrics.stringWidth(d.getDstatecode());
            g2d.drawString(titleText, (int) titleX, (int) titleY);
